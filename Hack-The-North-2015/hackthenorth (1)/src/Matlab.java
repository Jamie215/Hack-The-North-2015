...
public class Matlab extends javax.swing.JFrame {
    ...
    public void startMatlab()throws MatlabConnectionException, MatlabInvocationException, Exception {                                         
        ...
        try{
            ...
            double testing = 0;
            // proxy.returningFeval("testing", 1, testing);
            //Object[] o1 = proxy.returningEval("testing",1);
            //testing = (double[]) o1[0];
            
            proxy.setVariable("tina", 5);
            
            Object[] returnArguments = proxy.returningEval("testing", 1);
            ...
            //proxy.eval("tina = tina + 6");
            Object result = proxy.getVariable("tina");
            double result1 = ((double[]) proxy.getVariable("tina"))[0];
            
            System.out.println("Result: " + result1);
            
            //proxy.testing();
            //proxy.eval("sleepdetection");
            if (proxy.equals(o)) {
                new SimpleMail().test(IntroGUI.email);
            }
